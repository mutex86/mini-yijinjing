...
#include "mini_yijinjing/journal/Frame.hpp"  // for inline function
#include "mini_yijinjing/journal/IJournalVisitor.h"
#include "mini_yijinjing/journal/Journal.h"  // for inline function
#include "mini_yijinjing/journal/JournalHandler.h"
